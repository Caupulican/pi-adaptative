...
- evidence: packages/ai/src/utils/validation.ts:65 · packages/ai/src/utils/tool-repair/registry.ts:1 · packages/ai/test/tool-repair.test.ts:1 · packages/coding-agent/src/core/tools/edit.ts:95
- tags: tool-repair, validation, packages/ai, packages/coding-agent, roadmap-r31
