...
- evidence: packages/agent/src/session/session-manager.ts:999 · packages/agent/src/session/session-manager.ts:1182 · packages/ai/src/providers/openai-codex-responses.ts:884 · packages/ai/src/providers/openai-codex-responses.ts:1490 · packages/coding-agent/src/core/tool-recovery-log-records.ts:15 · packages/coding-agent/src/core/tool-recovery-logger.ts:216 · packages/coding-agent/src/core/context/context-store-retention.ts:119 · packages/coding-agent/src/core/tool-recovery-stats.ts:206 · packages/tui/src/undo-stack.ts:10 · packages/tui/src/kill-ring.ts:9
- tags: long-session, compaction, websocket, telemetry, retention, tui, packages/agent, packages/ai, packages/coding-agent, packages/tui, root-cause
