...
const codingAgentVerificationCoverageTests = [
	...
	"test/bash-background-git-filter.test.ts",
	"test/bash-background-shell.test.ts",
	"test/bash-background-barrier.test.ts",
	"test/bash-concurrent-lanes.test.ts",
	"test/bash-pinned-directory.test.ts",
