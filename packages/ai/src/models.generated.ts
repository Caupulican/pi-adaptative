...
export const MODELS = {
	"amazon-bedrock": {
		...
		"in.openai.gpt-5.6-luna": {
			...
			cost: {
				...
				cacheRead: 0.022,
				cacheWrite: 0.275,
				tiers: [{"inputTokensAbove":272000,"input":0.44,"output":1.98,"cacheRead":0.044,"cacheWrite":0.55}],
			},
			contextWindow: 1050000,
			maxTokens: 128000,
		} satisfies Model<"bedrock-converse-stream">,
		"in.openai.gpt-5.6-terra": {
			...
			cost: {
				...
				cacheRead: 0.22,
				cacheWrite: 2.75,
				tiers: [{"inputTokensAbove":272000,"input":4.4,"output":19.8,"cacheRead":0.44,"cacheWrite":5.5}],
			},
			contextWindow: 1050000,
			maxTokens: 128000,
		} satisfies Model<"bedrock-converse-stream">,
		...
		"openai.gpt-5.6-sol": {
			...
			cost: {
				...
				cacheRead: 0.44,
				cacheWrite: 5.5,
				tiers: [{"inputTokensAbove":272000,"input":8.8,"output":33,"cacheRead":0.88,"cacheWrite":11}],
			},
			contextWindow: 1050000,
			maxTokens: 128000,
		} satisfies Model<"bedrock-converse-stream">,
		...
		"openai.gpt-6-astra": {
			...
			cost: {
				...
				cacheRead: 1.1,
				cacheWrite: 13.75,
				tiers: [{"inputTokensAbove":272000,"input":22,"output":82.5,"cacheRead":2.2,"cacheWrite":27.5}],
			},
			contextWindow: 1050000,
			maxTokens: 128000,
		} satisfies Model<"bedrock-converse-stream">,
	...
	"github-copilot": {
		...
		"gpt-5.6-luna": {
			...
			cost: {
				...
				cacheRead: 0.02,
				cacheWrite: 0.25,
				tiers: [{"inputTokensAbove":200000,"input":0.4,"output":1.8,"cacheRead":0.04,"cacheWrite":0.5}],
			},
			contextWindow: 1050000,
			maxTokens: 128000,
		} satisfies Model<"openai-responses">,
	...
	"google": {
		...
		"gemini-2.5-computer-use-preview-10-2025": {
			...
			cost: {
				...
				cacheRead: 0,
				cacheWrite: 0,
				tiers: [{"inputTokensAbove":200000,"input":2.5,"output":15,"cacheRead":0,"cacheWrite":0}],
			},
			contextWindow: 131072,
			maxTokens: 65536,
		} satisfies Model<"google-generative-ai">,
		...
		"gemini-2.5-pro": {
			...
			cost: {
				...
				cacheRead: 0.125,
				cacheWrite: 0,
				tiers: [{"inputTokensAbove":200000,"input":2.5,"output":15,"cacheRead":0.25,"cacheWrite":0}],
			},
			contextWindow: 1048576,
			maxTokens: 65536,
		} satisfies Model<"google-generative-ai">,
	...
	"openai-codex": {
		...
		"gpt-5.6-luna": {
			...
			reasoning: true,
			defaultThinkingLevel: "medium",
			thinkingLevelMap: {"xhigh":"xhigh","max":"max","minimal":null,"off":null},
		...
		"gpt-5.6-sol": {
			...
			thinkingLevelMap: {"xhigh":"xhigh","max":"max","ultra":"max","minimal":null,"off":null},
			openaiResponsesLite: true,
			input: ["text", "image"],
			cost: {
				input: 4,
	...
	"opencode-go": {
		...
		"minimax-m3": {
			...
			cost: {
				...
				cacheRead: 0.06,
				cacheWrite: 0,
				tiers: [{"inputTokensAbove":512000,"input":0.6,"output":2.4,"cacheRead":0.12,"cacheWrite":0}],
			},
			contextWindow: 1000000,
			maxTokens: 131072,
		} satisfies Model<"anthropic-messages">,
		...
		"qwen3.6-plus": {
			...
			cost: {
				...
				cacheRead: 0.05,
				cacheWrite: 0.625,
				tiers: [{"inputTokensAbove":256000,"input":2,"output":6,"cacheRead":0.2,"cacheWrite":2.5}],
			},
			contextWindow: 1000000,
			maxTokens: 65536,
		} satisfies Model<"openai-completions">,
		...
		"qwen3.7-plus": {
			...
			cost: {
				...
				cacheRead: 0.04,
				cacheWrite: 0.5,
				tiers: [{"inputTokensAbove":256000,"input":1.2,"output":4.8,"cacheRead":0.12,"cacheWrite":1.5}],
			},
			contextWindow: 1000000,
			maxTokens: 65536,
		} satisfies Model<"openai-completions">,
	...
	"openrouter": {
		...
		"anthropic/claude-fable-5": {
			...
			thinkingLevelMap: {"off":null,"xhigh":"xhigh","max":"max","minimal":null,"low":"low","medium":"medium","high":"high"},
			input: ["text", "image"],
			cost: {
				input: 10,
				output: 50,
		...
		"anthropic/claude-opus-4.6": {
			...
			reasoning: true,
			defaultThinkingLevel: "high",
			thinkingLevelMap: {"max":"max","minimal":null,"low":"low","medium":"medium","high":"high","xhigh":null},
			input: ["text", "image"],
			cost: {
				input: 5,
				output: 25,
		...
		"anthropic/claude-opus-4.7": {
			...
			reasoning: true,
			defaultThinkingLevel: "high",
			thinkingLevelMap: {"xhigh":"xhigh","max":"max","minimal":null,"low":"low","medium":"medium","high":"high"},
			input: ["text", "image"],
			cost: {
				input: 5,
				output: 25,
		...
		"deepseek/deepseek-v4-pro": {
			...
			cost: {
				input: 0.655458,
				output: 1.310916,
				cacheRead: 0.054621499999999996,
				cacheWrite: 0,
			},
			contextWindow: 1048576,
			maxTokens: 384000,
		...
		"google/gemini-3.1-pro-preview": {
			...
			reasoning: true,
			defaultThinkingLevel: "medium",
			thinkingLevelMap: {"minimal":null,"low":"low","medium":"medium","high":"high","xhigh":null,"max":null,"off":null},
			input: ["text", "image"],
			cost: {
				input: 2,
				output: 12,
		...
		"google/gemini-3.5-flash": {
			...
			reasoning: true,
			defaultThinkingLevel: "medium",
			thinkingLevelMap: {"minimal":"minimal","low":"low","medium":"medium","high":"high","xhigh":null,"max":null,"off":null},
			input: ["text", "image"],
			cost: {
				input: 1.5,
				output: 9,
		...
		"meta/muse-glimmer-30b": {
			...
			reasoning: true,
			defaultThinkingLevel: "medium",
			thinkingLevelMap: {"minimal":null,"low":"low","medium":"medium","high":"high","xhigh":"xhigh","max":null,"off":null},
			input: ["text", "image"],
			cost: {
				input: 0.35,
				output: 1.5,
		...
		"meta/muse-spark-1.1": {
			...
			reasoning: true,
			defaultThinkingLevel: "medium",
			thinkingLevelMap: {"minimal":"minimal","low":"low","medium":"medium","high":"high","xhigh":"xhigh","max":null,"off":null},
			input: ["text", "image"],
			cost: {
				input: 1.25,
				output: 4.25,
		...
		"meta/muse-spark-1.3": {
			...
			reasoning: true,
			defaultThinkingLevel: "medium",
			thinkingLevelMap: {"minimal":"minimal","low":"low","medium":"medium","high":"high","xhigh":"xhigh","max":"max","off":null},
			input: ["text", "image"],
			cost: {
				input: 1.25,
				output: 4.25,
		...
		"openai/gpt-5-pro": {
			...
			reasoning: true,
			defaultThinkingLevel: "high",
			thinkingLevelMap: {"minimal":null,"low":null,"medium":null,"high":"high","xhigh":null,"max":null,"off":null},
			input: ["text", "image"],
			cost: {
				input: 15,
				output: 120,
		...
		"openai/gpt-5.2": {
			...
			reasoning: true,
			defaultThinkingLevel: "medium",
			thinkingLevelMap: {"xhigh":"xhigh","minimal":null,"low":"low","medium":"medium","high":"high","max":null},
			input: ["text", "image"],
			cost: {
				input: 1.75,
				output: 14,
		...
		"openai/gpt-5.2-codex": {
			...
			reasoning: true,
			defaultThinkingLevel: "medium",
			thinkingLevelMap: {"xhigh":"xhigh","minimal":null,"low":"low","medium":"medium","high":"high","max":null,"off":null},
			input: ["text", "image"],
			cost: {
				input: 1.75,
				output: 14,
		...
		"openai/gpt-5.2-pro": {
			...
			reasoning: true,
			defaultThinkingLevel: "medium",
			thinkingLevelMap: {"xhigh":"xhigh","minimal":null,"low":null,"medium":"medium","high":"high","max":null,"off":null},
			input: ["text", "image"],
			cost: {
				input: 21,
				output: 168,
		...
		"openai/gpt-5.5-pro": {
			...
			reasoning: true,
			defaultThinkingLevel: "medium",
			thinkingLevelMap: {"xhigh":"xhigh","off":null,"minimal":null,"low":null,"medium":"medium","high":"high","max":null},
			input: ["text", "image"],
			cost: {
				input: 30,
				output: 180,
		...
		"openai/gpt-6-astra": {
			...
			reasoning: true,
			defaultThinkingLevel: "medium",
			thinkingLevelMap: {"xhigh":"xhigh","max":"max","minimal":null,"low":"low","medium":"medium","high":"high","off":null},
			input: ["text", "image"],
			cost: {
				input: 10,
				output: 50,
		...
		"qwen/qwen3.8-2.4t-a95b": {
			...
			reasoning: true,
			defaultThinkingLevel: "xhigh",
			thinkingLevelMap: {"minimal":null,"low":"low","medium":"medium","high":null,"xhigh":"xhigh","max":null,"off":null},
			input: ["text"],
			cost: {
				input: 2,
				output: 6,
		...
		"sakana/fugu-max": {
			...
			reasoning: true,
			defaultThinkingLevel: "high",
			thinkingLevelMap: {"minimal":null,"low":null,"medium":null,"high":"high","xhigh":"xhigh","max":"max","off":null},
			input: ["text", "image"],
			cost: {
				input: 2,
				output: 6,
		...
		"z-ai/glm-5.3": {
			...
			reasoning: true,
			defaultThinkingLevel: "max",
			thinkingLevelMap: {"minimal":null,"low":"low","medium":null,"high":"high","xhigh":null,"max":"max","off":null},
			input: ["text"],
			cost: {
		...
		"~deepseek/deepseek-v4-flash-latest": {
			...
			cost: {
				input: 0.04972,
				output: 0.14916,
				cacheRead: 0.0015819999999999999,
				cacheWrite: 0,
			},
			contextWindow: 1310720,
			maxTokens: 131072,
