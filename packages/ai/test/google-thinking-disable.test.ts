...
import { liveEnvApiKey, liveEnvVar } from "./oauth.ts";
...
describe.skipIf(!liveEnvApiKey("anthropic"))("Anthropic thinking disable E2E", () => {
...
describe.skipIf(!liveEnvApiKey("google"))("Google thinking disable E2E", () => {
...
describe.skipIf(!liveEnvApiKey("openai"))("OpenAI thinking disable E2E", () => {
...
describe.skipIf(!liveEnvApiKey("openrouter"))("OpenRouter thinking disable E2E", () => {
