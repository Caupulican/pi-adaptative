...
describe("Context overflow error handling", () => {
	describe.skipIf(!liveEnvVar("ANTHROPIC_API_KEY"))("Anthropic (API Key)", () => {
		it("claude-haiku-4-5 - should detect overflow via isContextOverflow", async () => {
			const model = getModel("anthropic", "claude-haiku-4-5");
			const result = await testContextOverflow(model, liveEnvVar("ANTHROPIC_API_KEY")!);
			logResult(result);
	...
	describe.skipIf(!liveEnvVar("ANTHROPIC_OAUTH_TOKEN"))("Anthropic (OAuth)", () => {
		it("claude-sonnet-4 - should detect overflow via isContextOverflow", async () => {
			const model = getModel("anthropic", "claude-sonnet-4-6");
			const result = await testContextOverflow(model, liveEnvVar("ANTHROPIC_OAUTH_TOKEN")!);
			logResult(result);
	...
	describe.skipIf(!liveEnvApiKey("openai"))("OpenAI Completions", () => {
		it("gpt-4o-mini - should detect overflow via isContextOverflow", async () => {
			...
			const result = await testContextOverflow(model, liveEnvApiKey("openai")!);
			logResult(result);
	...
	describe.skipIf(!hasAzureOpenAICredentials())("Azure OpenAI Responses", () => {
		it("gpt-4o-mini - should detect overflow via isContextOverflow", async () => {
			...
			const result = await testContextOverflow(model, liveEnvApiKey("azure-openai-responses")!);
			logResult(result);
	...
	describe.skipIf(!liveEnvApiKey("google"))("Google", () => {
		it("gemini-2.0-flash - should detect overflow via isContextOverflow", async () => {
			...
			const result = await testContextOverflow(model, liveEnvApiKey("google")!);
			logResult(result);
	...
	describe.skipIf(!liveEnvApiKey("xai"))("xAI", () => {
		it("grok-4.6 - should detect overflow via isContextOverflow", async () => {
			const model = getModel("xai", "grok-4.6");
			const result = await testContextOverflow(model, liveEnvApiKey("xai")!);
			logResult(result);
	...
	describe.skipIf(!liveEnvApiKey("groq"))("Groq", () => {
		it("llama-3.3-70b-versatile - should detect overflow via isContextOverflow", async () => {
			...
			const result = await testContextOverflow(model, liveEnvApiKey("groq")!);
			logResult(result);
	...
	describe.skipIf(!liveEnvApiKey("cerebras"))("Cerebras", () => {
		it("available model - should detect overflow via isContextOverflow", async () => {
			...
			const result = await testContextOverflow(model, liveEnvApiKey("cerebras")!);
			logResult(result);
	...
	describe.skipIf(!liveEnvApiKey("huggingface"))("Hugging Face", () => {
		it("Kimi-K2.5 - should detect overflow via isContextOverflow", async () => {
			...
			const result = await testContextOverflow(model, liveEnvApiKey("huggingface")!);
			logResult(result);
	...
	describe.skipIf(!liveEnvApiKey("zai"))("z.ai", () => {
		it("glm-5.2 - should detect overflow via isContextOverflow when z.ai reports it", async () => {
			...
			const result = await testContextOverflow(model, liveEnvApiKey("zai")!);
			logResult(result);
	...
	describe.skipIf(!liveEnvApiKey("mistral"))("Mistral", () => {
		it("devstral-medium-latest - should detect overflow via isContextOverflow", async () => {
			...
			const result = await testContextOverflow(model, liveEnvApiKey("mistral")!);
			logResult(result);
	...
	describe.skipIf(!liveEnvApiKey("minimax"))("MiniMax", () => {
		it("MiniMax-M2.7 - should detect overflow via isContextOverflow", async () => {
			...
			const result = await testContextOverflow(model, liveEnvApiKey("minimax")!);
			logResult(result);
	...
	describe.skipIf(!liveEnvApiKey("xiaomi"))("Xiaomi MiMo (API billing)", () => {
		...
		it("mimo-v2.5-pro - should detect overflow via isContextOverflow", async () => {
			...
			const result = await testContextOverflow(model, liveEnvApiKey("xiaomi")!);
			logResult(result);
	...
	describe.skipIf(!liveEnvApiKey("xiaomi-token-plan-cn"))("Xiaomi MiMo Token Plan (CN)", () => {
		it("mimo-v2.5-pro - should detect overflow via isContextOverflow", async () => {
			...
			const result = await testContextOverflow(model, liveEnvApiKey("xiaomi-token-plan-cn")!);
			logResult(result);
	...
	describe.skipIf(!liveEnvApiKey("xiaomi-token-plan-ams"))("Xiaomi MiMo Token Plan (AMS)", () => {
		it("mimo-v2.5-pro - should detect overflow via isContextOverflow", async () => {
			...
			const result = await testContextOverflow(model, liveEnvApiKey("xiaomi-token-plan-ams")!);
			logResult(result);
	...
	describe.skipIf(!liveEnvApiKey("xiaomi-token-plan-sgp"))("Xiaomi MiMo Token Plan (SGP)", () => {
		it("mimo-v2.5-pro - should detect overflow via isContextOverflow", async () => {
			...
			const result = await testContextOverflow(model, liveEnvApiKey("xiaomi-token-plan-sgp")!);
			logResult(result);
	...
	describe.skipIf(!liveEnvApiKey("kimi-coding"))("Kimi For Coding", () => {
		it("kimi-for-coding - should detect overflow via isContextOverflow", async () => {
			...
			const result = await testContextOverflow(model, liveEnvApiKey("kimi-coding")!);
			logResult(result);
	...
	describe.skipIf(!liveEnvApiKey("vercel-ai-gateway"))("Vercel AI Gateway", () => {
		it("google/gemini-2.5-flash via AI Gateway - should detect overflow via isContextOverflow", async () => {
			...
			const result = await testContextOverflow(model, liveEnvApiKey("vercel-ai-gateway")!);
			logResult(result);
	...
	describe.skipIf(!liveEnvApiKey("openrouter"))("OpenRouter", () => {
		...
		it("anthropic/claude-sonnet-4 via OpenRouter - should detect overflow via isContextOverflow", async () => {
			...
			const result = await testContextOverflow(model, liveEnvApiKey("openrouter")!);
			logResult(result);
