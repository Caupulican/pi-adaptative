...
Stateful agent with tool execution and event streaming. Built on `@caupulican/pi-ai`.

## Installation

```bash
npm install @caupulican/pi-agent-core
```
...
```typescript
import { agentLoop, agentLoopContinue } from "@caupulican/pi-agent-core";
