...
- Root bash git is a read-only allowlist. Commit, tag, branch, rebase, update-ref, push, pull, and other mutating git are refused there. Typed delivery still owns root commit, push, and tag.
