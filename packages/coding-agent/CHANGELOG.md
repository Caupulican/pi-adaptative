...
- GPT-6 Astra is selectable on the Codex provider (`openai-codex` / `gpt-6-astra`) with the Responses Lite contract and reasoning levels low through ultra; see the ai package changelog for the catalogue details.
