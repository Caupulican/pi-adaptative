...
- Canonicalized system-prompt resources to LF before capability-budget enforcement, keeping constrained profiles byte-stable across Windows and POSIX checkouts.
