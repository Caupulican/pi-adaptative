...
const MANDATORY_FEATURE_IDS: readonly string[] = [
	...
	"capability_proof",
	"capability_activation_ephemeral_script",
	"capability_activation_extension",
	"capability_activation_runtime_patch",
	"capability_activation_toolkit_script",
	"capability_activation_tool",
	"capability_activation_skill",
	"capability_activation_composition",
	"capability_activation_integration",
	"capability_activation_provider_adapter",
	"runtime_adaptation",
	"semantic_dedup_pre",
	"semantic_dedup_post",
