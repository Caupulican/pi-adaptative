...
export interface ExtensionUIDialogOptions {
	...
	timeout?: number;
	/** Mask input and keep it out of UI editing history. Supported only by the interactive TUI host. */
	sensitive?: boolean;
}
...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `@caupulican/pi-adaptative` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "@caupulican/pi-adaptative";
	 *
...
export interface ExtensionContext {
	...
	/** Reload extensions, skills, prompts, and themes when the runtime is idle. */
	reload(): Promise<void>;
...
export interface SessionStartEvent {
	...
	reason: "startup" | "reload" | "new" | "resume" | "fork" | "load";
...
export interface SessionShutdownEvent {
	...
	reason: "quit" | "reload" | "new" | "resume" | "fork" | "unload";
...
export interface PythonToolCallEvent extends ToolCallEventBase {
	toolName: "python";
...
export interface PythonToolResultEvent extends ToolResultEventBase {
	toolName: "python";
...
export function isPythonToolResult(e: ToolResultEvent): e is PythonToolResultEvent {
	return e.toolName === "python";
}
...
export function isToolCallEventType(toolName: "python", event: ToolCallEvent): event is PythonToolCallEvent;
