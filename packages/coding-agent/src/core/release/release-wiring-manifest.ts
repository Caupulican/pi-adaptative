...
export const RELEASE_WIRING_MANIFEST: readonly ReleaseWiringEntry[] = [
	...
	{
		featureId: "capability_activation_extension",
		symbol: "extensionRuntime",
		implementationFile: "packages/coding-agent/src/core/adaptive/adaptive-capability-controller.ts",
		constructionOwnerFile: "packages/coding-agent/src/core/sdk.ts",
		triggerFile: "packages/coding-agent/src/core/adaptive/adaptive-capability-controller.ts",
		triggerSymbol: "extensions.reload",
		consumerFile: "packages/coding-agent/src/core/adaptive/adaptive-capability-controller.ts",
	...
	{
		featureId: "capability_activation_runtime_patch",
		...
		constructionOwnerFile: "packages/coding-agent/src/core/adaptive/adaptive-runtime-factory.ts",
		triggerFile: "packages/coding-agent/src/core/adaptive/adaptive-capability-controller.ts",
		triggerSymbol: "executeRuntimeModification",
		consumerFile: "packages/coding-agent/src/core/adaptive/adaptive-capability-controller.ts",
	...
	{
		featureId: "capability_activation_toolkit_script",
		symbol: "toolkit_script",
		implementationFile: "packages/coding-agent/src/core/adaptive/capability-kind-support.ts",
		constructionOwnerFile: "packages/coding-agent/src/core/adaptive/capability-kind-support.ts",
		triggerFile: "packages/coding-agent/src/core/adaptive/adaptive-capability-controller.ts",
		triggerSymbol: "resolveActivatableKind",
	...
	{
		featureId: "capability_activation_tool",
		symbol: "tool",
		implementationFile: "packages/coding-agent/src/core/adaptive/capability-kind-support.ts",
		constructionOwnerFile: "packages/coding-agent/src/core/adaptive/capability-kind-support.ts",
		triggerFile: "packages/coding-agent/src/core/adaptive/adaptive-capability-controller.ts",
	...
	{
		featureId: "capability_activation_skill",
		symbol: "skill",
		implementationFile: "packages/coding-agent/src/core/adaptive/capability-kind-support.ts",
		constructionOwnerFile: "packages/coding-agent/src/core/adaptive/capability-kind-support.ts",
		triggerFile: "packages/coding-agent/src/core/adaptive/adaptive-capability-controller.ts",
	...
	{
		featureId: "capability_activation_composition",
		symbol: "composition",
		implementationFile: "packages/coding-agent/src/core/adaptive/capability-kind-support.ts",
		constructionOwnerFile: "packages/coding-agent/src/core/adaptive/capability-kind-support.ts",
		triggerFile: "packages/coding-agent/src/core/adaptive/adaptive-capability-controller.ts",
	...
	{
		featureId: "capability_activation_integration",
		symbol: "integration",
		implementationFile: "packages/coding-agent/src/core/adaptive/capability-kind-support.ts",
		constructionOwnerFile: "packages/coding-agent/src/core/adaptive/capability-kind-support.ts",
		triggerFile: "packages/coding-agent/src/core/adaptive/adaptive-capability-controller.ts",
	...
	{
		featureId: "capability_activation_provider_adapter",
		symbol: "provider_adapter",
		implementationFile: "packages/coding-agent/src/core/adaptive/capability-kind-support.ts",
		constructionOwnerFile: "packages/coding-agent/src/core/adaptive/capability-kind-support.ts",
		triggerFile: "packages/coding-agent/src/core/adaptive/adaptive-capability-controller.ts",
		triggerSymbol: "resolveActivatableKind",
