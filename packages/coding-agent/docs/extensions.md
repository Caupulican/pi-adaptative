...
| Package | Purpose |
|---------|---------|
| `@caupulican/pi-adaptative` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
| `typebox` | Schema definitions for tool parameters |
| `@caupulican/pi-ai` | AI utilities (`StringEnum` for Google-compatible enums) |
| `@caupulican/pi-tui` | TUI components for custom rendering |
...
```typescript
import { isToolCallEventType } from "@caupulican/pi-adaptative";
...
```typescript
import { isBashToolResult } from "@caupulican/pi-adaptative";
...
```typescript
import { createLocalBashOperations } from "@caupulican/pi-adaptative";
...
```typescript
import { SessionManager } from "@caupulican/pi-adaptative";
...
```typescript
import type { AutocompleteItem } from "@caupulican/pi-tui";
...
```typescript
import { withFileMutationQueue } from "@caupulican/pi-adaptative";
...
**Important:** Use `StringEnum` from `@caupulican/pi-ai` for string enums. `Type.Union`/`Type.Literal` doesn't work with Google's API.
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@caupulican/pi-adaptative";
...
```typescript
import { createBashTool } from "@caupulican/pi-adaptative";
...
```typescript
import { Text, Component } from "@caupulican/pi-tui";
...
import { matchesKey } from "@caupulican/pi-tui";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@caupulican/pi-adaptative";
