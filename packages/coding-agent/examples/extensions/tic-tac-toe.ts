...
import type { ExtensionAPI, ExtensionContext, Theme, ToolExecutionMode } from "@caupulican/pi-adaptative";
import { StringEnum } from "@caupulican/pi-ai";
import { type Component, matchesKey, Text, truncateToWidth, visibleWidth } from "@caupulican/pi-tui";
